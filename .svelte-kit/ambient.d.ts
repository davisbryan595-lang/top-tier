...
declare module '$env/static/private' {
	export const FLY_PUBLIC_IP: string;
	export const FLY_VM_MEMORY_MB: string;
	export const FUSION_ENVIRONMENT: string;
	export const npm_config_user_agent: string;
	export const FLY_MACHINE_ID: string;
	...
	export const FLY_PRIVATE_IP: string;
	export const npm_config_audit: string;
	export const FLY_IMAGE_REF: string;
	...
	export const FLY_ALLOC_ID: string;
	export const NODE: string;
	export const npm_package_name: string;
	export const FLY_MACHINE_VERSION: string;
	export const npm_config_fetch_retry_mintimeout: string;
	export const cgroup_enable: string;
	...
	export const FLY_REGION: string;
	export const FLY_APP_NAME: string;
